      ...
      <div className="absolute top-0 left-0 right-0 z-20 border-b border-white/20">
        <div className="container mx-auto px-4 lg:px-8 py-3 lg:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <span className="text-white/60 text-[8px] lg:text-[10px] font-mono">ENGINEERS BEFORE UNIVERSITY</span>
          </div>
          
          <div className="hidden lg:flex items-center gap-3 text-[10px] font-mono text-white/60">
            <span>CAIRO: 30.0444</span>
            <div className="w-1 h-1 bg-white/40 rounded-full"></div>
            <span>ALEX: 31.2001</span>
          </div>
        </div>
      </div>
          ...
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="relative">
              ...
              <TextEffect
                ...
                per="word"
                preset="blur"
                className="text-4xl sm:text-5xl lg:text-7xl font-black text-white mb-4 lg:mb-5 leading-[0.95] tracking-tight"
              >
                Start Coding Before University
              </TextEffect>
            </div>
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                The only platform built for Egyptian Baccalaureate students who want to become software engineers.
              </p>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              <Link to="/auth/register" className="relative px-5 lg:px-6 py-3 lg:py-3.5 bg-blue-600 text-white font-mono text-xs lg:text-sm border border-blue-400 hover:bg-blue-500 transition-all duration-200 group text-center rounded-xl shadow-lg shadow-blue-600/20 hover:scale-[1.02]">
              ...
              <Link to="/courses" className="relative px-5 lg:px-6 py-3 lg:py-3.5 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200 text-center rounded-xl" style={{ borderWidth: '1px' }}>
                Explore Courses
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white"></div>
              <span className="text-white text-[9px] font-mono">CODESTART.ACADEMY</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute left-0 right-0 z-20 border-t border-white/20 bg-black/40 backdrop-blur-sm" style={{ bottom: '5vh' }}>
        <div className="container mx-auto px-4 lg:px-8 py-2 lg:py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:gap-4 text-[8px] lg:text-[9px] font-mono text-white/50">
            ...
            <span className="hidden lg:inline">THANAWYA TO ENGINEERING</span>
          </div>
        </div>
      </div>
