    ...
    <div className="min-h-screen flex flex-col relative w-full">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 py-6 md:px-10 md:py-8 max-w-[1440px] mx-auto w-full">
        ...
        <div className="hidden md:flex items-center gap-8">
          <span className="text-white font-black uppercase tracking-widest text-sm">ROBOTICS-CLUB.</span>
          <button
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="absolute top-20 left-0 w-full bg-black/95 p-6 flex flex-col items-center gap-4 md:hidden border-b border-white/10 z-50">
            <button
              onClick={() => {
