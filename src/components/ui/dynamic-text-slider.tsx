...
export function DynamicTextSlider() {
  ...
  return (
    <div className="w-full min-h-[70vh] bg-slate-50 dark:bg-[#0A0A0F] text-white flex flex-col items-center justify-center text-center p-6 font-sans">
      <div className="max-w-5xl">
        ...
        <p className="mt-8 text-lg md:text-xl max-w-2xl mx-auto text-gray-400">
          Study your school curriculum. Learn to code. Build real projects. All in one place.
        </p>
 ...
 */
function OpenSourceSlider({ width: initialWidth, height = 70, handleSize = 28, onChange }: { width: number; height?: number; handleSize?: number; onChange?: (value: { left: number; right: number; range: number }) => void }) {
