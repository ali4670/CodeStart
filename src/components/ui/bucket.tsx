...
const INITIAL_CHIPS = [
  {
    id: 1,
    title: "Egyptian-First",
    description: "Built for Thanaweya students",
    icon: SecurityCheckIcon,
  },
  {
    id: 2,
    title: "Gamified Learning",
    description: "XP, coins, badges, streaks",
    icon: ZapIcon,
  },
  {
    id: 3,
    title: "AI-Powered",
    description: "Explain, quiz, summarize anything",
    icon: AiBrain02Icon,
  },
  {
    id: 4,
    title: "Community-Driven",
    description: "Study groups & coding contests",
    icon: UserStoryIcon,
  },
];
